...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[65vh] md:h-screen">
      {/* Background Image */}
      <img
        src={bgImage}
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20 text-white">
        <div className="max-w-md text-center md:text-center lg:text-left mx-auto lg:mx-0">
          <h2 className="text-2xl md:text-5xl font-semibold">Get Yours Today!</h2>
          ...
          {/* Button Positioning */}
          <button className="mt-8 md:mt-6 px-6 py-3 bg-white text-black text-lg font-medium hover:bg-gray-200 transition">
            Buy now with 15% off
          </button>
        </div>
      </div>
